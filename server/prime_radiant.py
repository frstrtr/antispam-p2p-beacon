...
from server.api import SpammerCheckResource, ReportIdResource, RemoveIdResource, UnbanResource
...
def main():
    ...
    # Add the unban endpoint
    unban_resource = UnbanResource(p2p_factory)
    root.putChild(b"unban", unban_resource)
